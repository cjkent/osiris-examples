package ws.osiris.example.binary.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.binary.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.binary.core.config
}
