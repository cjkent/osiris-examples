package ws.osiris.example.cognito.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.cognito.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.cognito.core.config
}
