package ws.osiris.example.cors.core
 ...
 */
val api = api<CorsExampleComponents>(cors = true) {
 ...
 */
fun createComponents(): CorsExampleComponents = CorsExampleComponentsImpl()

/**
 * Simple components that only provides a [Gson] instance.
 */
interface CorsExampleComponents : ComponentsProvider {
    val gson: Gson
}

internal class CorsExampleComponentsImpl : CorsExampleComponents {
