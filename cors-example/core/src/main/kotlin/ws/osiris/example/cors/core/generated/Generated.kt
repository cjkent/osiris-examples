package ws.osiris.example.cors.core.generated
...
import ws.osiris.example.cors.core.api
import ws.osiris.example.cors.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.cors.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.cors.core.config
}
