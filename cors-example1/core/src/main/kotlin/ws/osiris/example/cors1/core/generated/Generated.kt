package ws.osiris.example.cors1.core.generated
...
import ws.osiris.example.cors1.core.api
import ws.osiris.example.cors1.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.cors1.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.cors1.core.config
}
