package ws.osiris.example.customauth1.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.customauth1.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.customauth1.core.config
}
