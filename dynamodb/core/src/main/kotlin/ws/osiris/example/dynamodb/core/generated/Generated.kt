package ws.osiris.example.dynamodb.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.dynamodb.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.dynamodb.core.config
}
