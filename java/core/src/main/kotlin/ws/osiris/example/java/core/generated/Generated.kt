package ws.osiris.example.java.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.java.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.java.core.config
}
