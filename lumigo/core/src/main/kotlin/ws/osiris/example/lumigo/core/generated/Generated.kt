package ws.osiris.example.lumigo.core.generated
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.lumigo.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.lumigo.core.config
}
