package ws.osiris.example.resources.core.generated
...
import ws.osiris.example.resources.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = ws.osiris.example.resources.core.api as Api<T>
    override val config: ApplicationConfig = ws.osiris.example.resources.core.config
}
