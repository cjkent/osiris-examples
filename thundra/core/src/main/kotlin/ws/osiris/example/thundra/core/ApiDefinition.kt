...
internal const val ITEMS_TABLE: String = "ThundraExampleItems"
 ...
 */
interface ThundraExampleComponents : ComponentsProvider {
 ...
 */
class ThundraExampleComponentsImpl : ThundraExampleComponents {
